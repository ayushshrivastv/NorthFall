 ...
 * northfall terminal (winter-shell). Covers real-time file generation monitoring and
        ...
        description: (
            <div>
                ...
                <div className="flex items-center gap-x-1.5">
                    ...
                    Northfall has its own custom terminal named north shell.
                </div>
                <div className="flex items-center gap-x-1.5">
                    <span>
                        <BiChevronsRight />
...
export const stepsRunCommands: Step[] = [
    {
        ...
        description: (
            <div className="flex items-center gap-x-1.5">
                <span className="font-semibold">north test: </span> runs the contract test files.
            </div>
        ),
    },
    {
        ...
        description: (
            <div className="flex items-center gap-x-1.5">
                <span className="font-semibold">north build: </span> compiles and builds your
                contract
            </div>
        ),
    },
    {
        ...
        description: (
            <div className="flex flex-col gap-y-1">
                <span className="font-semibold">north deploy: </span>
                <div className="flex items-center gap-x-1.5">
                    <span>
                        <BiChevronsRight />
                    </span>
