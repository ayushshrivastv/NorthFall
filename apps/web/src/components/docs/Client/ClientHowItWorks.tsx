        ...
        <div className="w-full h-full py-10 flex flex-col items-center text-left tracking-wide gap-y-5 ">
            <div className="flex flex-col gap-y-4 h-full ">
                ...
                {/* <div className="text-[18px] tracking-wider">
                    Let’s first dive into what Northfall actually does <span className="text-light/40 hover:text-[#a187fc] transition-colors duration-300">(because its kind of cool)</span>.
                </div> */}
                ...
                <div className="flex flex-col gap-y-4 tracking-wide text-light/90">
                    ...
                    <TitleDescription
                        ...
                        description="Run test commands, [ north test ], through north shell and see the test logs."
                    />

                    <TitleDescription
                        title="Build the contract"
                        description="Run build command, [ north build ], through north shell to build the contract and view build logs directly in the shell."
                    />
            ...
            <div className="h-full w-full max-w-4xl relative border border-neutral-800 rounded-[4px]">
                <Image
                    src={'/Images/northfall-architecture.png'}
                    alt="northfall-client-architecture"
                    fill
