...
export const stepsCreateYourAccount: Step[] = [
    {
        number: 1,
        title: 'Open Northfall',
        description: (
            <div className="flex flex-col gap-y-3">
                <p className="text-light/70 text-sm">Navigate to Northfall to get started</p>
                <a
                    href="https://northfall.dev"
                    target="_blank"
...
export const stepsBuildYourFirstContract = (
    ...
    },
    {
        ...
        description: 'Wait a few minutes and Northfall will start generating your contract files.',
    },
];
...
export const stepsGithubExport: Step[] = [
    ...
    },
    {
        ...
        description: 'If not linked, Northfall will prompt you to connect your GitHub.',
    },
    {
        number: 3,
...
export const stepsUpdateContract: Step[] = [
    ...
    },
    {
        number: 3,
        title: 'Regeneration',
        description: 'Northfall updates your files instantly based on the new prompt.',
    },
];
