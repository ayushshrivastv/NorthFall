        ...
        description: (
            <div className="space-y-1">
                ...
                <div className="flex items-center gap-x-1.5">
                    ...
                    Use the north shell and run the command from there.
                </div>
                <div className="flex items-center gap-x-1.5">
                    <span>
                        <BiChevronsRight />
                    </span>
                    Refer NorthFall Terminal section of the docs to deploy the contract from north
                    shell.
                </div>
            </div>
        ),
...
export const stepsDeployContract: Step[] = [
    ...
    },
    {
        ...
        description: (
            <div className="flex items-center gap-x-1.5">
                Wait for some time and northfall will deploy the contract to your selected network.
            </div>
        ),
    },
    {
