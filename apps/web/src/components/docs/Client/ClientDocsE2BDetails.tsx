...
const tabs = [
    ...
    },
    {
        ...
        content: {
            ...
            description:
                'Seamlessly transition from development to deployment. Test on devnet, validate on testnet, and deploy to mainnet, all from the same interface. Northfall handles the complexity so you can focus on building.',
        },
    },
];
