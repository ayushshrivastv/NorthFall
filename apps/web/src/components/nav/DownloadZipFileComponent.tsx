...
export default function DownloadZipFileComponent() {
    ...
    async function downloadZipFile() {
        ...
        try {
            ...
            link.href = url;
            link.download = `northfall-${contract_name}.zip`;
    ...
    return (
        <div className="px-4 py-2 text-[12.5px] text-light/70">
            <div
                ...
                className={`flex justify-between items-center w-full bg-dark/50 hover:bg-dark border border-neutral-800 p-1.5 px-2 rounded-[4px] tracking-wide ${downloading ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                    }`}
            >
